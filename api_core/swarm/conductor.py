...
from .headline_hunter import NewsScoutAgent
from .macro_lens import MacroContextAgent
from .chartcraft import TechnicalAgent
from .tape_reader import MarketReactionAgent
from .exposure_unit import RiskAgent
from .verdict_unit import DecisionAgent
...
try:
    from jolt_radar.sentinel import ShockAgent, build_shock_context_from_pipeline
except ImportError:
    ShockAgent = None
