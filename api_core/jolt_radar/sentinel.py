from jolt_radar.models import ShockPrecursorPattern
from jolt_radar.severity import get_current_score, get_hedge_suggestion
...
class ShockAgent:
    ...
    def run(self, context: dict) -> dict:
        """Alias for conductor compatibility with BaseAgent.run()."""
