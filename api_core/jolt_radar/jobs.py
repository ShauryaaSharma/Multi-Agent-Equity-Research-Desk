...
from jolt_radar.models import ShockAlert
from jolt_radar.wire_reader import poll_all_feeds
from jolt_radar.severity import (
    compute_article_score,
    update_shock_score,
    SCORE_THRESHOLD,
)
from jolt_radar.tg_notifier import send_telegram_alert
...
@shared_task(name='jolt_radar.jobs.poll_and_score')
def poll_and_score():
...
@shared_task(name='jolt_radar.jobs.fire_shock_alert')
...
@shared_task(name='jolt_radar.jobs.update_eod_feedback')
