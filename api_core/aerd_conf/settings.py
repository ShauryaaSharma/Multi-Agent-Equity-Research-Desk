...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'newswire/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# WSGI / ASGI
WSGI_APPLICATION = 'aerd_conf.wsgi.application'
ASGI_APPLICATION = 'aerd_conf.asgi.application'
