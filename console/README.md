# AERD - Financial Intelligence Platform Frontend
...
├── components/
│   ├── swarm/
│   │   └── UnitCard.tsx      # AI agent insight cards
│   ├── charts/
│   │   ├── PriceChart.tsx   # Main market chart
│   │   └── ToneChart.tsx # Sentiment trend chart
│   ├── news/
│   │   ├── WireCard.tsx       # Individual news item
│   │   └── WireFeed.tsx       # News feed container
│   ├── ticker/
│   │   ├── TapeBar.tsx   # Bottom scrolling ticker
│   │   ├── QuoteWidget.tsx    # Mini price display
│   │   └── SessionStatus.tsx   # Market status indicator
│   └── ui/                    # shadcn components
├── store/
│   ├── marketStore.ts         # Market data state
│   └── agentStore.ts          # AI agent insights state
├── hooks/
│   ├── useTapeStream.ts     # WebSocket hook for prices
│   └── useWireFeed.ts         # News feed data hook
├── lib/
