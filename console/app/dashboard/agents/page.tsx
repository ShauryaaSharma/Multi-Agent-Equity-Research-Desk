...
import { apiClient, type QuantCatalog } from '@/lib/httpClient';
...
export default function AgentsPage() {
  ...
  const { isLoading, result } = useSwarmInsights(activeTicker, { selectedIndicators });
  ...
  return (
    <div>
      ...
      <div className="card mb14">
        ...
        <ConductorList steps={result?.pipeline} isLoading={isLoading} />
      </div>
