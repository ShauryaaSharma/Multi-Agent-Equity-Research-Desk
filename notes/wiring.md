...
|-------------------|------------------|--------|---------|
| WireFeed | `/api/fetch-news/` | GET | Financial news from Alpha Vantage |
| PriceChart | `/api/market/<symbol>/history/` | GET | OHLC price history (yfinance) |
| ToneChart | `/api/chart-data/` | GET | Sentiment distribution & trend |
| TapeBar, QuoteWidget | `/api/live-ticker/` | GET | Live indices & stock prices |
| UnitCard | `/api/agents/run/` | POST | Multi-agent AI pipeline |
