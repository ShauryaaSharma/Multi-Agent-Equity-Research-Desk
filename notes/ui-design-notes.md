...
- `newswire/templates/index.html` — main page
- `newswire/static/css/console.css` — terminal theme (dark, ticker, cards)
- `newswire/static/js/console.js` — ticker, news, charts, deep-dive, swarm
...
3. **Integrate with Django:**
   ...
   - Keep the same `<script src="{% static 'js/console.js' %}">` (or your JS that calls the same APIs).
